...
class NPC(AnimatedSprite):
    def __init__(self, game, path='doom-fps/resources/sprites/npc/soldier/0.png', pos=(10.5,5.5), scale=0.6, shift=0.38, animation_time=180):
...
class CacoDemonNpc(NPC):
    def __init__(self, game, path='doom-fps/resources/sprites/npc/caco_demon/0.png', pos=(10.5, 6.5), scale=0.7, shift=0.27, animation_time=250):
        super().__init__(game, path, pos, scale, shift, animation_time)
...
class CyberDemonNpc(NPC):
    def __init__(self, game, path='doom-fps/resources/sprites/npc/cyber_demon/0.png', pos=(13.0, 6.5), scale=1.0, shift=0.04, animation_time=210):
        super().__init__(game, path, pos, scale, shift, animation_time)
        self.attack_dist = 6
        self.speed  = 0.055
        self.health = 200
